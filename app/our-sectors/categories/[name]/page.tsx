...
export default function CategoryProjectsPage({ params }: { params: { name: string } }) {
    ...
    const {
        ...
        loadMore,
        hasMore,
    } = projectsService.useInfiniteProjects(categoryName);
    ...
    return (
        <div className="container mx-auto py-24 px-4 text-center">
            <div className="max-w-4xl mx-auto mt-20">
                ...
                <Button onClick={() => router.push("/our-sectors/categories")} variant="ghost" className="mt-4">
...
return (
    <div className="container mx-auto py-24 px-4">
      <div className="max-w-2xl mx-auto text-center mb-16">
          <Button onClick={() => router.push("/our-sectors/categories")} variant="ghost" className="mb-8">
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to categories
          </Button>

        <h1 className="text-4xl font-bold tracking-tight sm:text-6xl mb-4">{categoryName} Projects</h1>
        <p className="text-lg text-muted-foreground">Explore our latest {categoryName} projects</p>
      </div>
